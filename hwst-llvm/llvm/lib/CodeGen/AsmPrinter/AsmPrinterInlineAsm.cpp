...
unsigned kenny_regnum; //global parameter for tracking bndr first register (bound container), newer version to mark spatial bound instruction into bndrs
...
void AsmPrinter::EmitInlineAsm(StringRef Str, const MCSubtargetInfo &STI,
  ...
  //printf("%s\n", Str.data()); //kenny print the bndr string
    ...
    if(!strncmp(Str.data(), "\tbndrs a0,", 10))
      kenny_regnum = 11;
    if(!strncmp(Str.data(), "\tbndrs a1,", 10))
      kenny_regnum = 12;
    if(!strncmp(Str.data(), "\tbndrs a2,", 10))
      kenny_regnum = 13;
    if(!strncmp(Str.data(), "\tbndrs a3,", 10))
      kenny_regnum = 14;
    if(!strncmp(Str.data(), "\tbndrs a4,", 10))
      kenny_regnum = 15;
    if(!strncmp(Str.data(), "\tbndrs a5,", 10))
      kenny_regnum = 16;
    if(!strncmp(Str.data(), "\tbndrs a6,", 10))
      kenny_regnum = 17;
    if(!strncmp(Str.data(), "\tbndrs a7,", 10))
      kenny_regnum = 18;
    if(!strncmp(Str.data(), "\tbndrs s0,", 10))
      kenny_regnum = 9;
    if(!strncmp(Str.data(), "\tbndrs s1,", 10))
      kenny_regnum = 10;
    if(!strncmp(Str.data(), "\tbndrs s2,", 10))
      kenny_regnum = 19;
    if(!strncmp(Str.data(), "\tbndrs s3,", 10))
      kenny_regnum = 20;
    if(!strncmp(Str.data(), "\tbndrs s4,", 10))
      kenny_regnum = 21;
    if(!strncmp(Str.data(), "\tbndrs s5,", 10))
      kenny_regnum = 22;
    if(!strncmp(Str.data(), "\tbndrs s6,", 10))
      kenny_regnum = 23;
    if(!strncmp(Str.data(), "\tbndrs s7,", 10))
      kenny_regnum = 24;
    //newly added
    if(!strncmp(Str.data(), "\tbndrs s8,", 10))
      kenny_regnum = 25;
    if(!strncmp(Str.data(), "\tbndrs s9,", 10))
      kenny_regnum = 26;
    if(!strncmp(Str.data(), "\tbndrs s10,", 11))
      kenny_regnum = 27;
    if(!strncmp(Str.data(), "\tbndrs s11,", 11))
      kenny_regnum = 28;
    if(!strncmp(Str.data(), "\tbndrs t0,", 10))
      kenny_regnum = 6;
    if(!strncmp(Str.data(), "\tbndrs t1,", 10))
      kenny_regnum = 7;
    if(!strncmp(Str.data(), "\tbndrs t2,", 10))
      kenny_regnum = 8;
    if(!strncmp(Str.data(), "\tbndrs t3,", 10))
      kenny_regnum = 29;
    if(!strncmp(Str.data(), "\tbndrs t4,", 10))
      kenny_regnum = 30;
    if(!strncmp(Str.data(), "\tbndrs t5,", 10))
      kenny_regnum = 31;
    if(!strncmp(Str.data(), "\tbndrs t6,", 10))
      kenny_regnum = 32;
    /*
