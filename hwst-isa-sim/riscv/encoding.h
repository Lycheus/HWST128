...
//OPC_BNDR 1110111 (0x77)
#define MATCH_BNDRS 0x7077      //funct3 111 funct7 0000000
#define MASK_BNDRS  0xfe00707f
#define MATCH_BNDRT 0x20007077  //funct3 111 funct7 0010000
#define MASK_BNDRT  0xfe00707f

#define MATCH_MBAS 0x3077  //funct3 011
#define MASK_MBAS  0x707f
#define MATCH_MBND 0x4077  //funct3 100
#define MASK_MBND  0x707f
#define MATCH_MKEY 0x5077  //funct3 101
#define MASK_MKEY  0x707f
#define MATCH_MLOC 0x6077  //funct3 110
#define MASK_MLOC  0x707f
#define MATCH_MVSR 0x2077  //funct3 010
#define MASK_MVSR  0x707f

//OPC_META_LOAD 1101011 (0x6b)
//#define MATCH_LBDU 0x5067 //funct3 101
//#define MATCH_LBDL 0x6067 //funct3 110
//#define MATCH_LBDUS 0x7067 //funct3 111
//#define MATCH_LBDLS 0x4067 //funct3 100
#define MATCH_LBDLS 0x6b      //funct3 000
#define MASK_LBDLS  0x707f
#define MATCH_LBDUS 0x106b      //funct3 001
#define MASK_LBDUS  0x707f
#define MATCH_LBDL 0x406b       //funct3 100
#define MASK_LBDL  0x707f
#define MATCH_LBDU 0x506b       //funct3 101
#define MASK_LBDU  0x707f
#define MATCH_LKEY 0x606b       //funct3 100
#define MASK_LKEY  0x707f
#define MATCH_LLOC 0x706b       //funct3 101
#define MASK_LLOC  0x707f


//#define MATCH_SBDU 0x2067 //funct3 010
//#define MATCH_SBDL 0x3067 //funct3 011

//OPC_LOAD_BND 0001011
...
//OPC_STORE_BND 0101011
#define MATCH_TCHK 0x102b //funct3 001
#define MASK_TCHK  0x707f
#define MATCH_SBDL 0x202b //funct3 010
#define MASK_SBDL  0x707f
#define MATCH_SBDU 0x302b //funct3 011
...
#define CAUSE_KEY_MISMATCH 0x11
#endif
#ifdef DECLARE_INSN
//DECLARE_INSN(bndi, MATCH_BNDI, MASK_BNDI)
DECLARE_INSN(bndrs, MATCH_BNDRS, MASK_BNDRS)
DECLARE_INSN(bndrt, MATCH_BNDRT, MASK_BNDRT)
DECLARE_INSN(mbas, MATCH_MBAS, MASK_MBAS)
DECLARE_INSN(mbnd, MATCH_MBND, MASK_MBND)
DECLARE_INSN(mkey, MATCH_MKEY, MASK_MKEY)
DECLARE_INSN(mloc, MATCH_MLOC, MASK_MLOC)
DECLARE_INSN(mvsr, MATCH_MVSR, MASK_MVSR)
DECLARE_INSN(tchk, MATCH_TCHK, MASK_TCHK)
DECLARE_INSN(lbdu, MATCH_LBDU, MASK_LBDU)
DECLARE_INSN(lbdl, MATCH_LBDL, MASK_LBDL)
DECLARE_INSN(lkey, MATCH_LKEY, MASK_LKEY)
DECLARE_INSN(lloc, MATCH_LLOC, MASK_LLOC)
...
DECLARE_CAUSE("key mismatch", CAUSE_KEY_MISMATCH)
#endif
