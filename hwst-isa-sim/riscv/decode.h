...
63         34 33    4 3               0
*/
#define C_BASE_BIT 32
#define C_BASE_MASK 0xFFFFFFFF00000000  //change the mask according to the BIT width
//#define C_RNGE_BIT 12
#define C_RNGE_BIT 32
//#define C_RNGE_MASK 0x3FFC00000
#define C_RNGE_MASK 0xFFFFFFFF

#define C_KEY_BIT 32
#define C_KEY_MASK 0xFFFFFFFF00000000
#define C_LOCK_BIT 32
#define C_LOCK_MASK 0xFFFFFFFF
...
/*
    printf("\n%08lX CHECK_BND:\nptr               :\t[%16lx]\ncompressed_spatial:\t[%16lx]\nlower             :\t[%16lx]\nupper             :\t[%16lx]\n\n", k_pc, addr, compressed_spatial, lower, upper); \
*/
// bound macros kenny support decompression
#define CHECK_BND(addr, reg, k_pc) ({		 \
      reg_t compressed_spatial = READ_BREG_L(reg);		\
      reg_t lower = compressed_spatial >> (64-C_BASE_BIT);		\
      reg_t upper = lower + ((compressed_spatial & C_RNGE_MASK) >> (64- C_BASE_BIT - C_RNGE_BIT )); \
      check_bounds(addr, upper, lower, k_pc);				\
    })

// temporal macros kenny: the temporal part of the metadata is from GPR which has already been decompressed by LKEY/LLOC
#define CHECK_KEY(key, lock, key_in_lock, k_pc) ({			\
      check_key(key, lock, key_in_lock, k_pc);				\
    })
